...
public class Odometer extends Thread {
  ...
  public void run() {
    ...
    while (true) {
      ...
      double distanceLeft = Math.PI * LocalizationLab.WHEEL_RADIUS
          * (nowLeftMotorTachoCount - getLeftMotorTachoCount()) / 180;
      double distanceRight = Math.PI * LocalizationLab.WHEEL_RADIUS
      ...
      double deltaT = (distanceLeft - distanceRight) / LocalizationLab.TRACK; // Change in heading
