...
public class UltrasonicPoller extends Thread {
  ...
  private UltrasonicLocalizer loc;
  private float[] usData;

  public UltrasonicPoller(SampleProvider us, float[] usData, UltrasonicLocalizer loc) {
    this.us = us;
    this.loc = loc;
    this.usData = usData;
  }
  ...
  public void run() {
    ...
    while (true) {
      ...
      if (distance != 0)
        loc.processUSData(distance); // now take action depending on value
