...
public class Odometer extends Thread {
  ...
  public void run() {
    ...
    while (true) {
      ...
      double distanceLeft = Math.PI * NavigationLab.WHEEL_RADIUS
          * (nowLeftMotorTachoCount - getLeftMotorTachoCount()) / 180;
      double distanceRight = Math.PI * NavigationLab.WHEEL_RADIUS
      ...
      double deltaT = (distanceLeft - distanceRight) / NavigationLab.TRACK; // Change in heading
